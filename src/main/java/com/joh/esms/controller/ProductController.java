...
public class ProductController {
    ...
    private String getAdminStock(Model model, @RequestParam(name = "page", required = false) Integer page, @RequestParam(name = "show", required = false) Integer showPerPage
            , @RequestParam(name = "stockId", required = false) Integer stockId, Principal principal) throws JsonProcessingException {
...
//		----
        ...
        double sumTotalCost = productDs.stream().mapToDouble(e -> (e.getCost() != null && e.getStockLevel() != null ? e.getCost() * e.getStockLevel() : 0.0)).sum();
    ...
    public ResponseEntity<InputStreamResource> downloadExcelStock(@RequestParam(name = "stockId", required = false) Integer stockId, Locale local,
                                                                  @RequestBody List<StockColumnD> selectedColumn,
    ...
    private String getAdminStock_info(Model model, @RequestParam(required = false) Integer stockId, Principal principal) throws JsonProcessingException {
