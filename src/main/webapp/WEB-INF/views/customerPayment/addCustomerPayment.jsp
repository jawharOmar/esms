...
<div ng-app="app" ng-controller="appCTRL" ng-init="init()" ng-form name="form">
            ...
            <div class="col-6 mx-auto">
                <div class="card customCard">
                    <div class="card-header">
                        <h4 class="mb-0 text-center text-white"><spring:message code="addCustomerPayment.title"/></h4>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="customer-autoselect"><spring:message
                                    code="addCustomerPayment.customerName"/></label>
                        ...
                        <div class="form-group">
                            <label for="customer_phone"><spring:message code="addCustomerPayment.phone"/></label>
                            <input required="required" readonly="readonly" id="customer_phone"
                                   class="form-control form-control-sm"
                                   ng-model="customerPayment.customer.phone">
                        </div>
                        <fieldset class="customFieldset">
                            <div class="form-group">
                                <label for="project"><spring:message code="addCustomerPayment.project"/></label>
                            ...
                            <div class="form-group">
                                <label for="totalPayment"><spring:message
                                        code="addCustomerPayment.totalPayment"/></label>
                                <input required name="totalPayment" type="number" id="totalPayment"
                                       step="any" ng-max="customerPayment.customer.totalLoan" min="0"
                            ...
                            <div class="form-group">
                                <label for="discount"><spring:message code="addCustomerPayment.discount"/></label>
                                <input required name="discount" type="number"
                                       step="any" min="0" id="discount"
                            ...
                            <div class="form-group">
                                <label for="loan"><spring:message code="addCustomerPayment.remain"/></label>
                                <input readonly="readonly" id="loan"
                        ...
                        <div class="text-center">
                            <button ng-disabled="!form.$valid || (customerPayment.customer.totalLoan-customerPayment.totalPayment-customerPayment.discount)<0"
                                    class="btn customBtn"
                                    ng-click="addCustomerPayment()">
