        ...
        <sec:authorize url="/adminRoot">
            <a href="<c:url value="/adminRoot" />">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/dashboard.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/customers">
            <a href="<c:url value="/customers"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/customers.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/customerOrders/add">
            <a href="<c:url value="/customerOrders/add"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/salePoint.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/customerOrders">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/customerOrders.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/productCategories">
            <a href="<c:url value="/productCategories"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/productCategory.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/stocks">
            <a href="<c:url value="/stocks"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/stocks.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/stockTransfers">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/stockTransfers.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/products">
            <a href="<c:url value="/products/stock"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/stock.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/orderProductStepUps/add">
            <a href="<c:url value="/orderProductStepUps/add"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/order.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/orderProductStepUps">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/viewOrders.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/vendors">
            <a href="<c:url value="/vendors"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/vendors.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/vendorPayments">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/vendorPayments.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/priceCategories">
            <a href="<c:url value="/priceCategories"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/priceCategory.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/expenses">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/expenses.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/incomeCategories">
            <a href="<c:url value="/incomeCategories"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/incomeCategory.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/incomes">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/incomes.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/orderPreProducts/add">
            <a href="<c:url value="/orderPreProducts/add"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/orderPreProduct.png" />"
                                alt=""/></td>
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                ...
                                alt=""/></td>
                        <td><spring:message code="layout.customerReturnWastedProducts"/></td>
                    </tr>
                </table>
            </a>
        </sec:authorize>
        ...
        <sec:authorize url="/accounts">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/account.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/boxAccounting">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/boxAccounting.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/netProfit">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/netProfit.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/users/userManager">
            <a href="<c:url value="/users/userManager"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/userManager.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/venderReturn">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/vReturn.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/withdraws">
            <a
                ...
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/withdraws.png" />"
                                alt=""/></td>
        ...
        <sec:authorize url="/setting">
            <a href="<c:url value="/setting"/>">
                <table class="card card-body">
                    <tr>
                        <td><img
                                src="<c:url value="/resources/img/settings.png" />"
                                alt=""/></td>
