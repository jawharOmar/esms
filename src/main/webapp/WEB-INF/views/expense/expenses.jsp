...
<div>
	...
	<h4>
		<spring:message code="adminExpenses.title" />
	</h4>

	<hr>

	<div>
		<form class="form-inline" action="<c:url value="/expenses" />">
         ...
         value = "${to}" />" />
			...
			<div class="form-group">
				<label for="from"><spring:message
						code="adminExpenses.expenseCategory" /></label> <select
					class="form-control mx-sm-3" name="cat">
	...
	<table id="table"
		...
		<thead>
			<tr>
				<th><spring:message code="adminExpenses.name" /></th>
				<th><spring:message code="adminExpenses.amount" /></th>
				<th><spring:message code="adminExpenses.expenseCategory" /></th>
				<th><spring:message code="adminExpenses.time" /></th>
				<th><spring:message code="adminExpenses.note" /></th>
				<th class="cus-not-search"><spring:message
						code="adminCustomers.function" /></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr class="text-info">
				<td><spring:message code="adminExpenses.total" /></td>
