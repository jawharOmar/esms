...
<div ng-controller="appCTRL" ng-init="init()">
	...
	<h2>
		<spring:message code="addCustomerOrderReturn.title" />
		${currentDate}
	</h2>
	<div>
	...
	<div class="border-top pt-2">
		<div>
			...
			<table ng-form="CustomerOrderReturnPrice">

				<tr>
					<td><spring:message code="addCustomerOrderReturn.totalPrice" /></td>
					<td><input ng-value="totalPrice()|number" style="width: 200px" ng-model="return.price"
						class="d-inline-block form-control form-control-sm"
						disabled="disabled">						<button class="btn btn-sm btn-info" ng-click="setTotalPayment()">
		...
		<button
			ng-disabled="!customerOrderReturn||!customerOrderReturn.productStepUps.length>0||CustomerOrderReturnForm.$invalid||CustomerOrderReturnPrice.$invalid"
			class="btn btn-success" ng-click="saveCustomerOrderReturn()">
			<i class="fa fa-plus"></i>
		</button>
	</div>
