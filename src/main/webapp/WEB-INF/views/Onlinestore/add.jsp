...
<div class="container p-1">
    <spring:url value="/store/list/add" var="urlaction"/>
        ...
        <div class="form-control align-middle border">
            ...
            <div class="col-12">
                <div id="ph_row" class="row d-flex align-items-center">
                    ...
                    <div class="col-md-auto m-3 border align-middle"
                         style=" padding:5px; cursor:pointer;border-radius: 5px;">
                        <label id="file0label" style="cursor:pointer;" class="text-center" for="file0"><p>Add Photo</p>
                            <i style="font-size:20px; color:#695DD5;" class="fa fa-plus-square" aria-hidden="true"></i></label>
