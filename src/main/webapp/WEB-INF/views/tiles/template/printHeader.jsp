...
<div style="width: 100%;" id="header">
	<table style="direction: ltr;">
		...
		<tr>
			<td width="33"><img style="max-width: 200px; padding: 4px"
				...
				height="200" alt="" /></td>
			<td width="34%">
				<h2 class="p-1" style="color: #2978B1; text-align: center">${setting.name}</h2>
	...
	<img style="max-height: 180px; padding: 4px"
		src="<c:url value="/resources/img/print_banner.png?" />${versionLogo}"
		height="180" alt="" />
</div>