...
<script type="text/javascript">
	...
	var customerReachLimit = '<spring:message code="addCustomerOrderReturn.customerReachLimit" />';
	var outOfTheStock = '<spring:message code="addCustomerOrderReturn.outOfTheStock" />';
</script>

<div ng-controller="addCustomerOrder" ng-init="init()">
	...
	<div class="row">
		<div class="col-2">
			<label class="checkboxLabel"
				ng-class="forPrintOnly?'selectedLabel':'unSelectedLabel'"
				for="forPrintOnly"> <spring:message
					code="addCustomerOrder.forPrintOnly" />
			</label> <input type="checkbox" id="forPrintOnly" value="true"
				ng-model="forPrintOnly" style="display: none;">
		</div>
		...
		<div class="col">
			<div class="form-inline">
				<div class="form-group mr-1">
					<label class="checkboxLabel"
						ng-class="showCost?'selectedLabel':'unSelectedLabel'"
						for="showCost"> <i class="fa fa-dollar"
						style="font-size: 24px"></i>
					</label> <input type="checkbox" id="showCost" value="false"
						ng-model="showCost" style="display: none;">
				</div>
				<div class="form-group mr-1">
					<label class="checkboxLabel"
				...
				<div class="form-group">
					<input class="form-control form-control" ng-model="invoiceId"
			...
			<thead>
				...
				<tr ng-form name="addProduct">
					...
					<th><input required tabindex="2" id="productName"
						ng-keypress="getKeys($event)" class="form-control form-control-sm"
					...
					<th><input ng-disabled="product.packetQuantity||priceToWeigth"
						min="0" max="{{!forPrintOnly?product.stockLevel:any}}"
						tabindex="3" type="number" required
						...
						<div class="row">
							<div class="input-group input-group-sm col-6 float-left mb-1">
								...
								<input min="0" type="number" step="any"
									...
									ng-model="customerOrder.discount" max="totalPrice()"
									class="form-control form-control-sm" />
							</div>
							<div class="input-group input-group-sm col-6 float-left mb-1">
								<div class="input-group-prepend">
