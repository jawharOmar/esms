            ...
            <div class="form-inline">
                ...
                <div class="form-group mr-1">
                    <a target="_blank" class="btn btn-outline-info"
                       href="<c:url value="/customerOrders/" />{{customerOrder.id}}/{{showLoan}}"> <i
                            class="fa fa-print"></i>
                    </a>
                </div>
                <div class="form-group mr-1">
        ...
        <table class="table table-bordered table-sm">
            ...
            <tr ng-form name="addProduct">
                ...
                <th><input ng-disabled="product.packetQuantity||priceToWeigth"
                           min="0" max="{{product.stockLevel}}" tabindex="3" type="number"
            ...
            <table style="width: 800px">
                <tr>
                    ...
                    <td><input id="totalPriceInput"
                        ...
                        <button class="btn btn-sm btn-info" ng-click="setTotalPayment()" ng-disabled="discountRatio==null">
                            <i class="fa fa-arrow-down"></i>
                        </button></td>
                </tr>
                <tr>
                    <td><spring:message code="addCustomerOrder.discount"/>
                        <input type="checkbox" ng-model="selectRatio"> <spring:message code="addCustomerOrder.ratio"/> :</td>
                    <td>
                        <div class="row">
                            ...
                            <div class="input-group input-group-sm col-6 float-left mb-1">
                                ...
                                <input min="0" type="number" step="any" ng-disabled="selectRatio || totalPrice()<=0"  ng-change="calculateTotalPayment()"
                                       ng-required="required" ng-model="customerOrder.discount" ng-max="totalPrice()"
                                       class="form-control form-control-sm"/>
                            </div>
                            <div class="input-group input-group-sm col-6 float-left mb-1">
                                <div class="input-group-prepend">
