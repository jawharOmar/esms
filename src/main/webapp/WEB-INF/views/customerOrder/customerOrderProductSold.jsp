...
<div>
	...
	<h4>
		<spring:message code="customerOrderProductSold.title" />
	</h4>
	<hr>
	...
	<div>
		<form action="<c:url value="/customerOrders/sold" />">
			<table>
				<tr>
					<td class="text-left"><spring:message
							code="customerOrderProductSold.from" /></td>
         ...
         value = "${from}" />" /></td>
				...
				<tr>
					<td class="text-left"><spring:message
							code="customerOrderProductSold.to" /></td>
         ...
         value = "${to}" />" /></td>
				...
				<tr>
					<td><input class="btn btn-outline-info" type="submit"
						value="<spring:message code="customerOrderProductSold.view" />" /></td>
				</tr>
			</table>
		</form>
	...
	<div style="overflow: auto">
		<table id="customerOrdersTable" class="display nowrap">
			<thead>
				<tr>
					<td>#C</td>
					<td><spring:message code="customerOrderProductSold.productName" /></td>
					<td><spring:message code="customerOrderProductSold.productCode" /></td>
					<td><spring:message code="customerOrderProductSold.quantity" /></td>
					<td><spring:message code="customerOrderProductSold.payment" /></td>
					<td><spring:message code="customerOrderProductSold.cost" /></td>
					<td><spring:message code="customerOrderProductSold.profit" /></td>
				</tr>
			</thead>
			<tbody>
