...
<div ng-app="customerWastedProduct" ng-controller="customerWastedProduct">
    <h2>
        <spring:message code="customerWastedProduct.title" />
    </h2>
    <hr>
    <div>
        <form class="form-inline"  action="<c:url value="/customerWastedProducts"/>">
                    ...
                    <td>
                        <div>
                            ...
                            <a class="btn btn-sm btn-outline-info" target="_blank"
                               href="<c:url value="/customerWastedProducts/" />${item.id}/print">
                            ...
                            <a href="<c:url value="/customerWastedProducts/edit/" />${item.id}"
