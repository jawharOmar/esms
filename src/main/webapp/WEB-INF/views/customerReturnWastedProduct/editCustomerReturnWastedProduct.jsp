			...
			<table id="detail-table" class="table table-bordered">
				<thead>
					<tr>
						...
						<td><spring:message code="stock.category" /></td>
						<td><spring:message code="addOrderPreProduct.quantity" /></td>
						<td><spring:message code="addOrderPreProduct.price" /></td>
