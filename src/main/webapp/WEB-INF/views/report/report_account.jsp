...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="card col p-0">
            <spring:url value="/report/get" var="auserActionUrl"/>
            <form action="${auserActionUrl}" method="post">
                <div class="card-header bg-dark text-white text-center">
                    <div class="card-title">
                        <h3><spring:message code="report.customers"/></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <div class="form-row justify-content-center">
                            <div class="col">
                                <select name="id" class="form-control" id="cus_names" required>
                                    <option></option>
                            ...
                            <div class="col">
                                <select class="form-control" name="pay">
                                    <option value="all" selected><spring:message code="report.all"/></option>
                                    ...
                                    <option value="Wasted Product"><spring:message code="report.wastedProduct"/></option>
                                </select></div>
                ...
                <div class="card-footer">
                    <button class="btn btn-info form-control" type="submit"><spring:message code="report.search"/></button>
                </div>
            </form>
        ...
        <div class="card col p-0">
            ...
            <spring:url value="/report/vget" var="vauserActionUrl"/>
            <form action="${vauserActionUrl}" method="post">


                <div class="card-header bg-dark text-white text-center">
                    <div class="card-title">
                        <h3><spring:message code="report.vendors"/></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <div class="form-row">
                            <div class="col">
                                <select name="id" class="form-control" id="cus_names1" required>
                                    <option value="" disabled selected><spring:message code="report.selectVendor"/></option>
