...
<div ng-app="app" ng-controller="appCTRL">
	...
	<hr>
	<div>
		<form class="form-inline" action="<c:url value="/venderReturns/view"/>">
			<sec:authorize url="/venderReturns/add">
				<div class="form-group mr-1">
					<a style="text-decoration: none;"
						class="col-md-auto rounded btn-success p-2"
						href="<c:url value="/venderReturns/add" />"> <spring:message
							code="layout.add" /> <i class="fa text-white fa-plus-circle"
						aria-hidden="true"></i>
					</a>
				</div>
			</sec:authorize>
			<div class="form-group">
				<label for="from"><spring:message
						code="customerOrderReturns.from" /></label> <input required readonly
         ...
         value="${from}" />" />
			...
			<div class="form-group">
				<label for="to"><spring:message
						code="customerOrderReturns.to" /></label> <input required readonly
					class="form-control mx-sm-3" id="to" name="to"
						...
						<td>
							...
							<div>
								...
								<a class="btn btn-sm btn-outline-info" target="_blank"
									href="<c:url value="/venderReturns/" />${item.id}/print"> <i
									class="fa fa-print"></i>
								</a>

								<sec:authorize url="/venderReturns/delete">
