...
<div ng-controller="myApp" ng-init="init()">
	...
	<div id="freeze">
		<table class="table table-sm cus-table-borderless" ng-form name="form">
			<tbody>
				...
				<tr>
					...
					<td><select required="required" ng-model="vendorname"
						ng-change="selectVendor()" class="form-control form-control-sm">
		...
		<table class="table table-bordered table-sm">
			<thead>
				...
				<tr>
					...
					<th><select ng-disabled="!selectedstock" id="cus_names"
					...
					<th><input required tabindex="2" id="productName"
						...
						readonly></th>
					<th><input disabled tabindex="3" type="number"
						class="form-control form-control-sm"
						ng-value="productDetail.amount"></th>
					<th><input tabindex="3" type="number" required
						class="form-control form-control-sm" ng-model="detail.qty"
						ng-max="{{productDetail.amount}}"></th>
					...
					<th>
						<div class="form-row">
							<div class="col-11">
								<input tabindex="5" type="number" step="any"
									class="form-control form-control-sm"
					...
					<th>
						<button tabindex="7" ng-disabled="!detail.product"
							class="btn btn-sm btn-primary" ng-click="addItem()">
		...
		<button class="btn btn-sm btn-success"
			ng-disabled="!venderReturns.venderReturnsDetail.length>0 || !venderReturns.vendor"
			ng-click="saveVenderReturn()">
