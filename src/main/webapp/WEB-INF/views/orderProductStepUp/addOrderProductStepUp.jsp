...
<script type="text/javascript">
	...
	var jsonCurrencyExchange = '<spring:escapeBody  javaScriptEscape="true">${currencyExchange}</spring:escapeBody>';
...
<div ng-app="app" ng-controller="appCTRL" ng-init="init()">
	...
	<div>
		<button class="btn btn-lg btn-outline-success" onClick="refresh()">
		...
		<table class="table table-bordered">
			<thead>
				...
				<tr ng-form="newProductStepUpForm">
					...
					<td>
						<div class="input-group">
							<div class="input-group-prepend">
								<button id="cus-btn-addstudent" ng-click="getAddProduct()"
									type="button" class="btn btn-success btn-sm"
									data-toggle="modal" data-target="#modal">
									<i class="fa fa-plus"></i>
								</button>
							</div>
							<input id="autoselect" ng-change="selectedProduct=null"
					...
					<td><select required class="form-control form-control-sm"
						ng-model="productStepUp.stock"
						ng-init="productStepUp.stock=stocks[0]"
			...
			<tbody>
				...
				<tr ng-repeat="item in orderProductStepUp.productStepUps">
					...
					<td>{{(item.paymentAmount *
						currencyExchange.curRate)|number:2}}</td>
	...
	<div class="border-top p-3">
			...
			<table>
				<tr>
					...
					<td><input style="width: 200px"
						...
						</button> <span class="ml-5 text-danger"> {{(totalPrice() *
							currencyExchange.curRate)|number:2}} <i class="fa fa-dollar"></i>
					</span></td>
				</tr>
				...
				<tr>
					<td><spring:message code="addOrderProductStepUp.discount" />
						<input type="checkbox" ng-model="selectRatio"> <spring:message
							code="addOrderProductStepUp.ratio" /> :</td>
					<td>
						<div
							class="input-group input-group-sm col-lg-3 col-md-3 col-sm-4 float-left mb-1"
							...
							<input min="0" type="number" step="any"
								...
								ng-model="orderProductStepUp.discount" max="totalPrice()"
								class="d-inline-block form-control form-control-sm" />
						</div>
						<div
							class="input-group input-group-sm col-lg-3 col-md-3 col-sm-4 float-left mb-1">
							...
							<input min="0" type="number" step="1" ng-max="100"
								...
								ng-disabled="!selectRatio || totalPrice()<=0"
								ng-value="!selectRatio?discountRatio=0:0" ng-required="required"
								ng-model="discountRatio"
								class="d-inline-block form-control form-control-sm" />
						</div>
		...
		<button
			ng-disabled="orderProductStepUp.totalPayment>paymentValidation||!orderProductStepUp||!orderProductStepUp.productStepUps.length>0||orderProductStepUpForm.$invalid || discountRatio<0"
