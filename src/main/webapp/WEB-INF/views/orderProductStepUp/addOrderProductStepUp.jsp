    ...
    <div class="border-top">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><spring:message code="addOrderProductStepUp.packetQuantity"/></td>
                <td><spring:message code="addOrderProductStepUp.quantity"/></td>
                <td><spring:message code="addOrderProductStepUp.payment"/> (USD)</td>
            ...
            <tr ng-form="newProductStepUpForm">
                ...
                <td>
                    <input type="number" min="0" ng-change="paymentChangeCurrency()"
                           ng-model="paymentAmountToChange" ng-disabled="currencyExchange==null"
                           class="form-control form-control-sm">
                </td>
            ...
            <tr ng-repeat="item in orderProductStepUp.productStepUps">
                ...
                <td>{{item.quantity}}</td>
                <td>{{(item.paymentAmount * currencyExchange.curRate)|number:2}}</td>
                ...
                <tr>
                    ...
                    <td><input style="width: 200px"
                        ...
                        <span class="ml-5 text-danger">
                            {{(totalPrice() * currencyExchange.curRate)|number:2}}
