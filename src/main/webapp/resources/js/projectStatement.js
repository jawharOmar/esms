...
appAddCusotmerOrder.controller('appCTRL', function ($scope, $http,$window) {
    ...
    $scope.projectStatement = function () {
        ...
        var urlVariables="customerId="+$scope.customer.id+"&projectId="+$scope.projectId+"&actionType="+$scope.actionType;
        $window.open( $$ContextURL + "/report/projectStatement?"+urlVariables,"_self");
    }
