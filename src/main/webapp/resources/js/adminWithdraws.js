...
function getAddingWithdraw() {
    console.log("getAddingWithdraw->fired");
    $.get($$ContextURL + "/withdraws/add", function(response) {
...
function deleteWithdraw(id) {
    ...
    $.when(cusConfirm()).done(function() {
        ...
        $.ajax({
            type : "POST",
            url : $$ContextURL + "/withdraws/delete/" + id,
...
function editingWithdraw(id) {
    console.log("editingWithdraw->fired");

    $.ajax({
        type : "GET",
        url : $$ContextURL + "/withdraws/edit/" + id,
        contentType : "application/json",
        success : function(response) {
            $("#modal-body").html(response);
            $("#modal").modal("show");
