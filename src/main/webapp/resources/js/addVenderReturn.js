...
app
    .controller(
        ...
        function($scope, $http, $q) {
            ...
            $scope.resetdetail = angular
                .copy($scope.detail);
            $scope.resetproduct = angular
                .copy($scope.product);
            $scope.resetlastprice = angular
                .copy($scope.lastprice);
            ...
            $scope.getlastPrice=function(){
                ...
                $http({
                    method : 'GET',
                    url : $$ContextURL + '/venderReturn/getPrice/'+$scope.product.id
            ...
            $scope.selectVendor=function(){
                $http({
                    method : 'GET',
                    url : $$ContextURL + '/venderReturn/getVender/'+$scope.vendorname
                }).then(function(response) {
            ...
            $scope.findproduct=function(){
                ...
                $http({
                    method : 'GET',
                    url : $$ContextURL + '/venderReturn/getProduct/'+$scope.product.id+'/stock/'+$scope.selectedstock
                }).then(function(response) {
            ...
            $scope.totalPrice = function() {
                ...
                for (var i = 0; i < $scope.venderReturns.venderReturnsDetail.length; i++) {
                    totalPrice += $scope.venderReturns.venderReturnsDetail[i].amount*$scope.venderReturns.venderReturnsDetail[i].qty;
                }
                return totalPrice;
            }
            ...
            $scope.addItem=function(){
                ...
                $scope.venderReturns.venderReturnsDetail.unshift($scope.detail);
                ...
                $scope.productDetail= angular.copy($scope.resetproductDetail);
